 ...
 * @since 2.0
 */
public class DefaultExtjsGenerator extends AbstractExtjsGenerator {

	private static Configuration freemarkerConfiguration = FreeMarkerConfigurationFactory
			.createConfigurationByClass(DefaultExtjsGenerator.class);

	private static final String FTL_NAME = "js.ftl";

	protected ModelAndTableToJSTCodeSupport modelAndTableToJSTCodeSupport = new DefaultModelAndTableToJSTCodeSupport();
